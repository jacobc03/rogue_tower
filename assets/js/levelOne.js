...
var levelOneState = {
    ...
    create: function() {
        ...
        //  This stops the ground from falling away when the user jumps on it
        ledge = [];
        // create ledge function
        Levels.createLedge(ledge, platforms);
        //ledge for door     
    ...
    update: function() {
        ...
        game.physics.arcade.overlap(player, door1, nextLevel, null, this);
        game.physics.arcade.overlap(player, door2, nextLevel, null, this);
        // If the player overlaps with the dragon, Call fightDragonScence
        game.physics.arcade.overlap(player, dragon, battleScene, null, this);
        // If the player overlaps with the creeps, Call fightDragonScence
        game.physics.arcade.overlap(player, creeps, battleScene, null, this);
        ...
        game.physics.arcade.overlap(dragon, creeps, battleScene, null, this);
        game.physics.arcade.overlap(door1, creeps, battleScene, null, this);
        game.physics.arcade.overlap(door2, creeps, battleScene, null, this);
